...
# tushare-api = { version = "1.1.2", features = ["rust_decimal", "chrono"] }

# Or enable all third-party types
# tushare-api = { version = "1.1.2", features = ["all_types"] }

# Optional: Enable tracing support
# tushare-api = { version = "1.1.2", features = ["tracing"] }
```
...
```toml
[dependencies]
tushare-api = "1.1.2"  # Without tracing feature
tracing = "0.1"
tracing-subscriber = "0.3"
tracing-log = "0.2"
```
